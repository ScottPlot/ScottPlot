...
namespace ScottPlotTests
{
    public static class Report
    {
        ...
        public static void MakeMarkdown()
        {
            ...
            md += "This page was automatically generated by a the [ScottPlotTests](https://github.com/swharden/ScottPlot/tree/master/test/ScottPlotTests) program. ";
            md += "Note that these graphs are being generated from a Console Application (not a GUI / user control).\n\n";
            md += "In these examples, `xs` and `ys` are large double arrays.\n\n";
            foreach (var snippit in codeSnippits)
            {
                md += $"## {snippit.pic}\n";
