...
_This cookbook was automatically generated by [/cookbook/src](/cookbook/src) using ScottPlot 3.1.7.0_
...
plt.SaveFig("Figure_01a_Scatter_Sin.png");
```
...
plt.SaveFig("Figure_01b_Automatic_Margins.png");
```
...
plt.SaveFig("Figure_01c_Defined_Axis_Limits.png");
```
...
plt.AxisZoom(2, 2);
plt.AxisPan(-10, .5);
plt.SaveFig("Figure_01d_Zoom_and_Pan.png");
```
...
plt.SaveFig("Figure_01e_Legend.png");
```
...
plt.Legend();
plt.SaveFig("Figure_01f_Custom_Marker_Shapes.png");
```
...
plt.SaveFig("Figure_01g_All_Marker_Shapes.png");
```
...
plt.SaveFig("Figure_02_Styling_Scatter_Plots.png");
```
...
plt.SaveFig("Figure_03_Plot_XY_Data.png");
```
...
plt.SaveFig("Figure_04_Plot_Lines_Only.png");
```
...
plt.SaveFig("Figure_05_Plot_Points_Only.png");
```
...
plt.SaveFig("Figure_06_Styling_XY_Plots.png");
```
...
plt.Legend();
plt.SaveFig("Figure_06b_Custom_LineStyles.png");
```
...
plt.SaveFig("Figure_07_Plotting_Points.png");
```
...
plt.SaveFig("Figure_08_Plotting_Text.png");
```
...
plt.Clear();
plt.PlotScatter(dataRandom1, dataRandom2);
plt.SaveFig("Figure_09_Clearing_Plots.png");
```
...
plt.SaveFig("Figure_10_Modifying_Plotted_Data.png");
```
...
plt.SaveFig("Figure_11_Modify_Styles_After_Plotting.png");
```
...
plt.SaveFig("Figure_12_Date_Axis.png");
```
...
plt.SaveFig("Figure_13_Ruler_Mode.png");
```
...
plt.PlotScatter(dataXs, dataSin);
plt.PlotScatter(dataXs, dataCos);
plt.SaveFig("Figure_20_Small_Plot.png");
```
...
plt.SaveFig("Figure_21a_Title_and_Axis_Labels.png");
```
...
plt.SaveFig("Figure_21c_Automatic_Left_Padding.png");
```
...
plt.SaveFig("Figure_22_Custom_Colors.png");
```
...
plt.PlotScatter(dataXs, dataSin);
plt.PlotScatter(dataXs, dataCos);
plt.SaveFig("Figure_23_Frameless_Plot.png");
```
...
plt.PlotScatter(dataXs, dataCos);
plt.Grid(false);
plt.SaveFig("Figure_24_Disable_the_Grid.png");
```
...
plt.Grid(false);
plt.Frame(right: false, top: false);
plt.SaveFig("Figure_25_Corner_Axis_Frame.png");
```
...
plt.Frame(left: false, right: false, top: false);
plt.SaveFig("Figure_26_Horizontal_Ticks_Only.png");
```
...
plt.SaveFig("Figure_27_Very_Large_Numbers.png");
```
...
plt.SaveFig("Figure_28_Axis_Exponent_And_Offset.png");
```
...
plt.SaveFig("Figure_28b_Multiplier_Notation_Default.png");
```
...
plt.SaveFig("Figure_28c_Multiplier_Notation_Disabled.png");
```
...
plt.PlotScatter(dataXs, dataSin);
plt.PlotScatter(dataXs, dataCos);
plt.SaveFig("Figure_29_Very_Large_Images.png");
```
...
plt.SaveFig("Figure_30a_Signal.png");
```
...
plt.SaveFig("Figure_30c_SignalConst.png");
```
...
plt.SaveFig("Figure_32_Signal_Styling.png");
```
...
plt.SaveFig("Figure_40_Vertical_and_Horizontal_Lines.png");
```
...
plt.SaveFig("Figure_41_Axis_Spans.png");
```
...
plt.SaveFig("Figure_50_StyleBlue1.png");
```
...
plt.SaveFig("Figure_51_StyleBlue2.png");
```
...
plt.SaveFig("Figure_52_StyleBlue3.png");
```
...
plt.SaveFig("Figure_53_StyleLight1.png");
```
...
plt.SaveFig("Figure_54_StyleLight2.png");
```
...
plt.SaveFig("Figure_55_StyleGray1.png");
```
...
plt.SaveFig("Figure_56_StyleGray2.png");
```
...
plt.SaveFig("Figure_57_StyleBlack.png");
```
...
plt.SaveFig("Figure_58_StyleDefault.png");
```
...
plt.SaveFig("Figure_59_StyleControl.png");
```
...
plt.Legend();
plt.SaveFig("Figure_60_Plotting_With_Errorbars.png");
```
...
plt.SaveFig("Figure_61_Plot_Bar_Data.png");
```
...
plt.Legend();
plt.SaveFig("Figure_62_Plot_Bar_Data_Fancy.png");
```
...
plt.SaveFig("Figure_63_Step_Plot.png");
```
...
plt.SaveFig("Figure_64_Manual_Grid_Spacing.png");
```
...
plt.Axis(null, null, 0, null);
plt.SaveFig("Figure_65_Histogram.png");
```
...
plt.SaveFig("Figure_67_Candlestick.png");
```
...
plt.XLabel("Day (into Q4)");
plt.PlotOHLC(ohlcs);
plt.SaveFig("Figure_68_OHLC.png");
```
...
plt.SaveFig("Figure_70_Save_Scatter_Data.png");
```
...
plt.SaveFig("Figure_71_Save_Signal_Data.png");
```
...
plt.SaveFig("Figure_72_Custom_Fonts.png");
```
