...
This page was automatically generated by [ScottPlotTests](https://github.com/swharden/ScottPlot/tree/master/test/ScottPlotTests) (a Console Application). In these examples, `xs` and `ys` double arrays.
