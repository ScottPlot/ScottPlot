...
public class CustomAxisDemo : IDemo
{
    ...
    {
        return new CustomAxisWindow();
    }

}

public class CustomAxisWindow : SimpleDemoWindow
{
    public CustomAxisWindow() : base("Custom Axis")
    {
    ...
    protected override void StartDemo()
    {
        ...
        AvaPlot.Plot.Axes.Remove(AvaPlot.Plot.Axes.Left);
        AvaPlot.Plot.Axes.AddLeftAxis(customLeftAxis);
    }
