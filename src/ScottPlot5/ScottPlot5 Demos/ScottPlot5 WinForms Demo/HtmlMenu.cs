...
<body>
    ...
    <section class=""cards"">
        ...
        <div class=""card"" onclick=""postIt()"">
            <div class=""card-title"">Highlight Nearest</div>
            <div>
                This demo creates a scatter plot and continuously tracks the mouse,
                highlighting the data point closest to the cursor.
            </div>
        </div>
