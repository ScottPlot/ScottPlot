...
public record LegendPack(
    ItemSizeAndChildren[] SizedItems,
    PixelRect LegendRect,
    PixelRect LegendShadowRect,
    Pixel Offset)
{
    public static LegendPack GetLegendPack(Legend legend, int maxWidth, int maxHeight)
    {
        ...
        PixelSize legendSize = LegendSizing.GetLegendSize(legend, sizedItems, maxWidth: maxWidth, maxHeight: maxHeight, withOffset: true);
    ...
    public static LegendPack GetLegendPack(Legend legend, PixelRect dataRect)
    {
        LegendItem[] items = GetItemLogic.GetItems(legend);
        ...
        PixelSize legendSize = LegendSizing.GetLegendSize(legend, sizedItems,
