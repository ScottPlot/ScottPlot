...
public class NumericAutomatic : ITickGenerator
{
    ...
    private Tick[] GenerateTicks(CoordinateRange range, Edge edge, PixelLength axisLength, PixelLength maxLabelLength, Paint paint, LabelStyle labelStyle, int depth = 0)
    {
        if (depth > 3)
