...
public class TriangularAxis(bool clockwise) : IPlottable
{
    ...
    private void RenderBackground(RenderPack rp, SKPaintAndFont paint)
    {
    ...
    private void RenderEdge(RenderPack rp, SKPaintAndFont paint, TriangularAxisEdge edge)
    {
        // edge line
    ...
    private void RenderGridLines(RenderPack rp, SKPaintAndFont paint, TriangularAxisEdge edge1, TriangularAxisEdge edge2, bool reverse = true)
    {
