...
namespace ScottPlot.Plottable
{
    ...
    public class PopulationPlot : IPlottable
    {
        ...
        /// <summary>
        /// Overides alpha value of box plots. Alpha of box plots is typically controlled  
        /// using the DataFormat field. If BoxAlphaOverride != null, the alpha value from generated by DataFormat will be 
        /// overriden. For example, setting BoxAlphaOverride = 0 will make the boxes completely transparent  
        /// even if a DataFormat is set to DisplayItems.BoxAndScatter.
        /// </summary>
