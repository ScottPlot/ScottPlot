...
namespace ScottPlot.Renderable
{
    static class AxisTicksRender
    {
        ...
        public static void RenderGridLines(PlotDimensions dims, Graphics gfx, double[] positions,
            LineStyle gridLineStyle, System.Drawing.Color gridLineColor, float gridLineWidth, Edge edge)
        {
        ...
        public static void RenderTickMarks(PlotDimensions dims, Graphics gfx, double[] positions, float tickLength, System.Drawing.Color tickColor, Edge edge, float pixelOffset)
        {
