/* This application generates the images and Markdown pages used to build the cookbook website.
 * This application is intended to be executed from inside Visual Studio.
 */
