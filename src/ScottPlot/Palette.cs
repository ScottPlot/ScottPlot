...
namespace ScottPlot
{
    ...
    public static class Palette
    {
        ...
        public static ScottPlot.Drawing.Palette DarkLight => new(new ScottPlot.Drawing.Colorsets.DarkLight());
...
namespace ScottPlot.Drawing
{
    ...
    public class Palette
    {
        ...
        public static Palette DarkLight => new(new Colorsets.DarkLight());
