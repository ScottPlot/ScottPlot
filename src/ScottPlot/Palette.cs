...
namespace ScottPlot
{
    ...
    public static class Palette
    {
        ...
        public static ScottPlot.Drawing.Palette ColorBlindness => new(new ScottPlot.Drawing.Colorsets.ColorBlindness());
...
namespace ScottPlot.Drawing
{
    ...
    public class Palette
    {
        ...
        public static Palette ColorBlindness => new(new Colorsets.ColorBlindness());
