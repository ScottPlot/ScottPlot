...
namespace ScottPlot
{
    ...
    public static class Palette
    {
        ...
        public static ScottPlot.Drawing.Palette ColorBlindness => new(new ScottPlot.Drawing.Colorsets.ColorblindFriendly());
...
namespace ScottPlot.Drawing
{
    ...
    public class Palette
    {
        ...
        public static Palette ColorBlindness => new(new Colorsets.ColorblindFriendly());
