...
namespace ScottPlot
{
    public class PlottableBarObsolete : Plottable
    {
        public double[] xs;
        public double[] ys;
        public double[] yErr;
        ...
        public PlottableBarObsolete(double[] xs, double[] ys, double barWidth, double xOffset, Color color, string label, double[] yErr, double errorLineWidth = 1, double errorCapSize = 3)
        {
            if ((xs == null) || (ys == null))
